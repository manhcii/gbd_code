                                            ...
                                            <ol class=" dd-list" id="block_selected">
                                                <?php $__currentLoopData = $block_selected; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <li class="dd-item" data-id="<?php echo e($item->id); ?>">
                                                        ...
                                                        <div class="dd-handle">
                                                            <a style="z-index: 99" target="_blank" href="<?php echo e(route('block_contents.edit', $item->id)); ?>">Link</a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\gbd\resources\views/admin/pages/pages/edit.blade.php ENDPATH**/ ?>