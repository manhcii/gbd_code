    ...
    <div class="phone-vr">
      ...
      <div class="phone-vr-img-circle">
        <a target="_blank" href="<?php echo e($web_information->social->zalo); ?>">
          <img src="<?php echo e(asset('themes/frontend/watches/images/icon/zalo.png')); ?>" alt="phone"/>
        </a>
      </div>
    </div>
  </div>
      ...
      <div class="phone-vr">
        ...
        <div class="phone-vr-img-circle">
          <a href="tel:<?php echo e($web_information->social->call_now); ?>">
            <img src="<?php echo e(asset('themes/frontend/watches/images/icon/phone.png')); ?>" alt="zalo"/>
          </a>
        </div>
      </div>
    </div>
...
<?php /**PATH E:\xampp\htdocs\gbd\resources\views/frontend/components/sticky/contact.blade.php ENDPATH**/ ?>