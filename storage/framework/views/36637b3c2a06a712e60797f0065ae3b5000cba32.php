...
<head>
    ...
    <link rel="icon" href="<?php echo e($web_information->information->favicon ?? ''); ?>" type="image/x-icon">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('themes/frontend/watches/css/demo.css')); ?>" />
</head>
...
<body class="page--styles-preview">
            ...
            <div class="marketing-nav-wrapper headroom headroom--verytop headroom--top" role="navigation"
                ...
                <nav class="marketing-nav marketing-nav__primary" id="HaravanMainNav" itemscope="itemscope"
                    ...
                    <ul class="marketing-nav__items marketing-nav__user">
                        <li>
                            <a target="_blank" href="<?php echo e(route('frontend.contact')); ?>" class="d-md-inline-block btn-registration">Chọn giao diện này</a>
                            <a href="<?php echo e(route('frontend.home')); ?>" class="marketing-nav__item hide--mobile link-theme"
    ...
    <script src="<?php echo e(asset('themes/frontend/watches/js/demo.js')); ?>"></script>
    <script src="<?php echo e(asset('themes/frontend/watches/js/api.jquery.js')); ?>"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            var url_theme = "<?php echo e($detail->json_params->link_demo??""); ?>";
            var url_product =
    ...
    <script>
        var page_loading_gif_3 = '<?php echo e(url('data/images/page-loading-gif-3.webp')); ?>';
        var loading = '<?php echo e(url('data/images/loading.gif')); ?>';
...
</html><?php /**PATH E:\xampp\htdocs\gbd\resources\views/frontend/pages/demo.blade.php ENDPATH**/ ?>