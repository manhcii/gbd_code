          ...
          <img class="m-l-15" src="<?php echo e(asset('themes/frontend/watches/images/right-icon.svg')); ?>" alt="slide">
                ...
                <div class="col-lg-7 col-md-12 col-12 right-side">
                    <div class="quanlity-item">
                        <div class="wrap-img">
                            <img class="img-fluid h-100" src="<?php echo e(asset('themes/frontend/watches/images/reason-img1.png')); ?>" alt="Văn hoá">
                        </div>
                    ...
                    <div class="presige-item">
                        ...
                        <div class="wrap-img">
                            <img class="img-fluid h-100" src="<?php echo e(asset('themes/frontend/watches/images/reason-img2.png')); ?>" alt="Văn hoá">
                        </div>
                    </div>
                </div>
            </div>
...
<?php endif; ?><?php /**PATH E:\xampp\htdocs\gbd\resources\views/frontend/blocks/service/styles/reason.blade.php ENDPATH**/ ?>