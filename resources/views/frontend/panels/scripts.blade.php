<script src="{{ asset('themes/frontend/watches/swiper/swiper-bundle.min.js') }}"></script>
<script src="{{ asset('themes/frontend/watches/fontawesome/fontawesome.js') }}"></script>
<script src="{{ asset('themes/frontend/watches/js/index.js') }}"></script>
<script src="{{ asset('themes/frontend/watches/js/skrollr.min.js') }}"></script>
