        ...
        <div class="footer-main">
            <div class="footer-element footer-element-info">
                <div class="footer-home">
                    <img src="{{ $web_information->image->logo_footer ?? asset('themes/frontend/watches/images/footer_home.svg') }}"
                        alt="">
                </div>
                <ul>
                    <li>
                        <p><i class="fa fa-map-marker"></i>{{ $web_information->information->address ?? '' }}</p>
                    </li>
                    <li>
                        <div class="header-info header-info-last header-info-last">
                            <div class="header-info-item header-info-item-footer">
                                <div class="header-info-icon">
                                    <img src="{{ asset('themes/frontend/watches/images/titok.svg') }}"
                                        alt="Track Your Order" title="Track Your Order" />
                                </div>
                                <div class="header-info-icon">
                                    <img src="{{ asset('themes/frontend/watches/images/tele.svg') }}"
                                        alt="Track Your Order" title="Track Your Order" />
                                </div>
                                <div class="header-info-icon">
                                    <img src="{{ asset('themes/frontend/watches/images/face.svg') }}"
                                        alt="Track Your Order" title="Track Your Order" />
                                </div>
                                <div class="header-info-icon">
                                    <img src="{{ asset('themes/frontend/watches/images/twitter.svg') }}"
                                        alt="Track Your Order" title="Track Your Order" />
                                </div>
                                <div class="header-info-icon">
                                    <img src="{{ asset('themes/frontend/watches/images/insta.svg') }}"
                                        alt="Track Your Order" title="Track Your Order" />
                                </div>
                            </div>
                        </div>
                ...
                <div class="footer-social">
                    <div class="d-flex align-items-center">
                        <div class="foot-hotline">
                            <img src="{{ asset('themes/frontend/watches/images/hotline_footer.svg') }}" alt="">
                        </div>
                    ...
                    <div class="d-flex align-items-center mt-20">
                        <div class="foot-hotline">
                            <img class="object-fit-contain"
                                src="{{ asset('themes/frontend/watches/images/mail_footer.svg') }}" alt="">
                        </div>
                        <div class="foot-detail-hotline">
                            <p>Hotline</p>
