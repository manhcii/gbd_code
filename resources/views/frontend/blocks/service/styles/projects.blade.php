@if ($block)
    ...
    <section class="projects">
        <div class="container">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="project-item">
                                ...
                                <div class="project-info">
                                    <h4>{{ $brief }}</h4>
                                    <h3>{{ $title }}</h3>
                                    <a href="{{ $link_demo }}"> <button type="button" class="btn btn-warning link_demo">Link
                                            demo</button></a>
            ...
            <a class="read-more d-flex align-items-center" href="{{ $url_link }}"
                title="Tìm hiểu">{{ $url_link_title }}</a>
        </div>
    </section>
@endif
