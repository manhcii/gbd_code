...
@push('style')
    ...
    <link rel="preload" as='style' type="text/css"
        href="{{ asset('themes/frontend/watches/bizweb.dktcdn.net/100/429/689/themes/869367/assets/blog_article_style.scss2c6f.css?1697597694844') }}">
    <link
        href="{{ asset('themes/frontend/watches/bizweb.dktcdn.net/100/429/689/themes/869367/assets/blog_article_style.scss2c6f.css?1697597694844') }}"
        rel="stylesheet" type="text/css" media="all" />
    <link rel="preload" as='style' type="text/css"
        href="{{ asset('themes/frontend/watches/bizweb.dktcdn.net/100/429/689/themes/869367/assets/sidebar_style.scss2c6f.css?1697597694844') }}">
    <link
        href="{{ asset('themes/frontend/watches/bizweb.dktcdn.net/100/429/689/themes/869367/assets/sidebar_style.scss2c6f.css?1697597694844') }}"
        rel="stylesheet" type="text/css" media="all" />
                                        ...
                                        <div class="article-details clearfix">
                                            ...
                                            <div class="time-post">
                                                ...
                                                <span class="icon posted">
                                                    <span class="text bold">{{ $detail->taxonomy_title }}</span> | <span
